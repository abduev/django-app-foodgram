# Generated by Django 3.0.5 on 2021-10-21 17:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='recipe_images/', verbose_name='Recipe image')),
                ('cooking_time', models.PositiveIntegerField(verbose_name='cooking_time (min)')),
                ...
                ('ingredients', models.ManyToManyField(through='api.IngredientInRecipe', to='api.Ingredient', verbose_name='Ingredients in recipe')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
            fields=[
                ...
                ('color', colorfield.fields.ColorField(choices=[('#FED764', 'Yellow'), ('#7FBFBF', 'Blue'), ('#C9B2D9', 'Lilac')], default='#FFFFFF', max_length=18, unique=True, verbose_name='Tag color')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_cart', to='api.Recipe')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='unit', to='api.Unit', verbose_name='Ingredient measurement_unit'),
        ),
        migrations.CreateModel(
            name='Favorite',
            fields=[
