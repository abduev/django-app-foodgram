...
const UserPage = ({ updateOrders }) => {
  ...
  return <Main>
    <Container className={styles.container}>
      <MetaTags>
        <title>{user ? `${user.first_name} ${user.last_name}` : 'Profile'}</title>
        <meta name="description" content={user ? `FOODGRAM - ${user.first_name} ${user.last_name}` : 'FOODGRAM - Profile'} />
        <meta property="og:title" content={user ? `${user.first_name} ${user.last_name}` : 'Profile'} />
      </MetaTags>
